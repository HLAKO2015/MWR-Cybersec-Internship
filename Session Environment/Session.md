...
## 3.2 Thinking like an attcker and a defender at the same time

### 3.2.1 Usename Enumeration
...
### 3.2.2 Login Features & Password reset features
- Username exists/found
- Bad credentials
- User not found
- User found and email sent

### 3.2.3 Password Attacks
